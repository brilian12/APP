    ...
    <div class="container-fluid">
        ...
        <div class="row register-form">
            <div class="col-md-8 offset-md-2">
                <form action="/backend/updateapp" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <div class="input-group mb-3">
                        <input type="date" class="form-control" placeholder="Birthday" name="birthday" value="{{ $customers->birthday }}">
